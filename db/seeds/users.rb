...
User.create!({
  ...
  image: ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{File.dirname(__FILE__)}/fixtures/guest_user.jpg"),
...
User.create!({
  ...
  image: ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{File.dirname(__FILE__)}/fixtures/user1.jpg"),
    filename: "user1.jpg")
})
...
User.create!({
  ...
  image: ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{File.dirname(__FILE__)}/fixtures/user2.jpg"),
    filename: "user2.jpg")
})
...
User.create!({
  ...
  image: ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{File.dirname(__FILE__)}/fixtures/user3.jpg"),
    filename: "user3.jpg")
})
