...
理由としては、課題であった宿泊サイトは、予約、お知らせ、レビューと言った</br>
連動が求められるCRUD機能を始め、ホストゲスト間でのインターアクティブな操作が伴うことから、</br>
DB設計の堅実性、加えてMVCにおけるロジックの役割性、メンテナンス性が求められ、</br>
railsを学習する上で最適な作成対象であると考えたからです。</br>
ポートフォリオを作ること、完成させることが目的になりがちですが、</br>
自分としては作成を通じてrailsの知識を増やし、スキルをさらに高めていくことをより重要視しました。</br>
